...
public:
    ...
    struct AdpData {
        bool dhcp;
        int defaultOn = -1;
        MIB_IPFORWARDROW ifRow;
        QString friendlyName;
        QString adpName;
        QString dnsAddrs;
    };
    QMap<uint, AdpData> ifMap;
    ...
    QVector<MIB_IPFORWARDROW> customRoutes;
